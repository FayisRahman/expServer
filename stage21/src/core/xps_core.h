...
struct xps_core_s {
  ...
  vec_void_t pipes;
  vec_void_t sessions;
  vec_void_t timers;            //TODO: stage 21
  u_int n_null_listeners;
  u_int n_null_connections;
  u_int n_null_pipes;
  u_int n_null_sessions;
  u_int n_null_timers;          //TODO: stage 21

  u_long curr_time_msec;        //TODO: stage 21
  u_long init_time_msec;        //TODO: stage 21
};

xps_core_t *xps_core_create(xps_config_t *config);
void xps_core_destroy(xps_core_t *core);
void xps_core_start(xps_core_t *core);
void xps_core_update_time(xps_core_t *core); //TODO: stage 21
